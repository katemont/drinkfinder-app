...
User.delete_all
User.create(email: "kate@drinkfindr.com", password: "password", role: "admin", username: "Monty", name: "Kate Montgomery")
User.create(email: "chris@drinkfindr.com", password: "password", role: "admin", username: "Chris", name: "Chris McMahon")
...
Recommendation.create(review: "Gastropub heaven – have drinks downstairs and then dine finely upstairs or grab an unbookable table at the back downstairs with dramatic views of the kitchen", tag_list: "original gastropub")
Recommendation.create(review:"A wacky alternative to the grit and bare bricks of East London, the vibrant décor and always busy surroundings mean it's never just one drink. They also have an extensive and decent wine list", tag_list: "alternative, young, English wine")
Recommendation.create(review:"Oasis of uber-contemporary Zen in the heart of the hubbub, great cocktails although they come at a price", tag_list: "w rock tea, hotel")
Recommendation.create(review:"A solid, old-school pub to shelter from the winter cold, with a fabulous wine list and amazing food if you so wish. Worth going for the rabbit done on the charcoal grill alone", tag_list: "British, wine, foodie, classic")
...
Bar.create(name:"The Gilbert Scott", location: "Kings Cross")
Bar.create(name:"The Windmill", location: "Mayfair")
Bar.create(name:"The Euston Tap", location: "Euston")
Bar.create(name:"The New St Wine Shop", location: "Liverpool St")
